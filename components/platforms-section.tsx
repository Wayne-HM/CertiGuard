...
function PlatformCard({ platform, index }: { platform: typeof platforms[0], index: number }) {
  ...
  return (
    ...
    >
      <div className="relative glass-card rounded-3xl p-8 h-full flex flex-col items-center text-center overflow-hidden border-glass-border hover:border-primary/40 transition-colors duration-500">
        ...
        <div className="flex items-center gap-2 text-xs font-bold text-primary tracking-widest uppercase opacity-0 group-hover:opacity-100 transition-opacity duration-300">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex flex-col items-center gap-2 opacity-30 hover:opacity-100 transition-opacity">
            ...
            <div className="text-[10px] font-bold tracking-[0.3em] text-primary uppercase">Live Feed</div>
          </div>
          <div className="flex flex-col items-center gap-2 opacity-30 hover:opacity-100 transition-opacity">
            <div className="text-2xl font-black text-foreground">ISO/IEC</div>
            <div className="text-[10px] font-bold tracking-[0.3em] text-emerald-500 uppercase">Secured</div>
          </div>
          <div className="flex flex-col items-center gap-2 opacity-30 hover:opacity-100 transition-opacity">
            <div className="text-2xl font-black text-foreground">SHA-512</div>
            <div className="text-[10px] font-bold tracking-[0.3em] text-accent uppercase">Encryption</div>
          </div>
        </motion.div>
      </div>
    </section>
