      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            {/* Designed & Developed Card */}
            <div className="mt-8 max-w-[280px] glass border border-white/5 bg-slate-900/50 rounded-2xl p-6 text-center shadow-lg">
              <div className="flex justify-center mb-4">
                <Code className="w-5 h-5 text-neon-blue opacity-80" />
              </div>
